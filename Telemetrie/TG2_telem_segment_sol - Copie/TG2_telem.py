...
import TG2_telem_epy_block_0 as epy_block_0  # embedded python block
import osmosdr
import time
...
class TG2_telem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.bauds = bauds = 2400
        self.squelch = squelch = -55
        self.samp_rate3 = samp_rate3 = bauds*10
        ...
        self.mmse_resampler_xx_0_0 = filter.mmse_resampler_ff(0, (samp_rate/samp_rate3))
        self.mmse_resampler_xx_0 = filter.mmse_resampler_cc(0, (samp_rate/samp_rate2))
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_BLACKMAN,
                6.76))
        self.epy_block_0 = epy_block_0.blk(baudrate=bauds, sampling=samp_rate3)
        ...
        self.band_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.audio_sink_0 = audio.sink(samp_rate3, 'Haut-parleurs', True)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_quadrature_demod_cf_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.analog_quadrature_demod_cf_1, 0), (self.qtgui_time_sink_x_0_0_1_0, 0))
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.audio_sink_0, 0))
        self.connect((self.blocks_threshold_ff_0, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_threshold_ff_0, 0), (self.qtgui_time_sink_x_0_0_1, 0))
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_0_0_1_1, 0))
        self.connect((self.low_pass_filter_0, 0), (self.mmse_resampler_xx_0_0, 0))
        self.connect((self.mmse_resampler_xx_0, 0), (self.qtgui_waterfall_sink_x_0_0, 0))
        self.connect((self.mmse_resampler_xx_0_0, 0), (self.blocks_threshold_ff_0, 0))
    ...
    def set_bauds(self, bauds):
        self.bauds = bauds
        self.set_samp_rate3(self.bauds*10)
        self.epy_block_0.baudrate = self.bauds
    ...
    def set_samp_rate3(self, samp_rate3):
        ...
        self.epy_block_0.sampling = self.samp_rate3
        self.mmse_resampler_xx_0_0.set_resamp_ratio((self.samp_rate/self.samp_rate3))
        self.qtgui_time_sink_x_0_0_1.set_samp_rate(self.samp_rate3)
        self.qtgui_time_sink_x_0_0_1_1.set_samp_rate(self.samp_rate3)
    ...
    def set_samp_rate2(self, samp_rate2):
        ...
        self.mmse_resampler_xx_0.set_resamp_ratio((self.samp_rate/self.samp_rate2))
        self.qtgui_waterfall_sink_x_0_0.set_frequency_range(0, self.samp_rate2)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_quadrature_demod_cf_1.set_gain((self.samp_rate/(2*math.pi*self.fsk_deviation_hz)))
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, (self.fsk_deviation_hz-self.doppler), (self.fsk_deviation_hz+self.doppler), (self.doppler/4), window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 19200, 1920, window.WIN_BLACKMAN, 6.76))
        self.mmse_resampler_xx_0.set_resamp_ratio((self.samp_rate/self.samp_rate2))
        self.mmse_resampler_xx_0_0.set_resamp_ratio((self.samp_rate/self.samp_rate3))
